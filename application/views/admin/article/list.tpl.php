...
<tbody><tr>
	...
	<td width="84%"><a class="blue1"   href="/admin/article/add/">Добавить</a></td>
</tr>
<tr>
...
<tr id="<?=$v->id?>tr" bgcolor="F8FAFC" onmouseout="this.bgColor = '#F8FAFC'" onmouseover="this.bgColor = '#EFF3F7'">	<td title="Дата" class="blue1"><?=$v->dates?></td>
	...
	<td title="Редактировать"><a  href="/admin/article/edit/<?=$v->id?>"><img width="20" height="20" border="0" alt="Редактировать" src="/img/admin/b_edit.gif"></a></td>
