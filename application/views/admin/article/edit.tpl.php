...
<tr>
	...
	<td class="blue1"><div id="logo"><?php if(!empty($post['image'])) echo"<img src=/userfiles/article_images/".$post['image'].">"; ?></div><br>
	...
	<input type="hidden" value="" name="d[image]" id="d_image_url" >
		...
		<tbody><tr>
			...
			<td class="blue1">
				<a onclick="window.open('/admin/article/uploadimg', 'image', 'top=150,left='+(window.screen.availWidth - 410)/2+', height=135, width=400'); retunr false;" href="#"><img width="20" height="20" border="0" align="absmiddle" src="/img/admin/b_img.gif"></a>
				<a class="blue1" onclick="window.open('/admin/article/uploadimg', 'image', 'top=150,left='+(window.screen.availWidth - 410)/2+', height=135, width=400'); return false;" href="#">Загрузить фотографию</a></td>
		</tr>
<tr bgcolor="F8FAFC">
